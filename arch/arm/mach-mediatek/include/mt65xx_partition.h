...
extern part_t* mt6575_part_get_partition(char *name);
extern part_dev_t* mt6575_part_get_device(void);
extern void mt6575_part_init(unsigned long totalblks);
extern void mt6575_part_dump(void);
