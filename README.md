...
- **as kernel**: `sudo -E ./target/release/da-boot --lk ../mtkclient/lk-a369.img --kernel ../mt6572/u-boot-new/u-boot.bin -p ../mtkclient/preloader-a369i.img --dram-size-per-rank 0x20000000 --dram-ranks 1 lk`
- **as lk**: `sudo -E ./target/release/da-boot --input ../mt6572/u-boot-new/u-boot.bin@0x85000000 -p ../mtkclient/preloader-d101.img --dram-size-per-rank 0x20000000 --dram-ranks 2 -j 0x85000000 preloader`
